namespace Fanzoo.Kernel.Defaults.Builder
{
    ...
    {
        public static WebApplicationBuilder AddRazorPagesCore<TUserAuthenticationService>(this WebApplicationBuilder builder, Action<AddMvcCoreConfiguration>? options = null)
